...
CREATE TABLE `stats_competition` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(50) NOT NULL, `short_name` varchar(5) NOT NULL, `mode` varchar(1) NOT NULL, `classification` varchar(5) NOT NULL);
...
CREATE TABLE `stats_game` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date` date NOT NULL, `name` varchar(50) NOT NULL);
CREATE TABLE `stats_goal` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `minute` smallint NOT NULL);
CREATE TABLE `stats_matchday` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(50) NOT NULL, `short_name` varchar(5) NOT NULL, `next_matchday_id` integer NULL);
...
ALTER TABLE `stats_matchday` ADD COLUMN `season_id` integer NOT NULL;
ALTER TABLE `stats_matchday` ALTER COLUMN `season_id` DROP DEFAULT;
...
ALTER TABLE `stats_game` ADD COLUMN `matchday_id` integer NOT NULL;
ALTER TABLE `stats_game` ALTER COLUMN `matchday_id` DROP DEFAULT;
ALTER TABLE `stats_game` ADD COLUMN `next_game_id` integer NULL;
ALTER TABLE `stats_game` ALTER COLUMN `next_game_id` DROP DEFAULT;
...
CREATE INDEX stats_matchday_0783d889 ON `stats_matchday` (`next_matchday_id`);
ALTER TABLE `stats_matchday` ADD CONSTRAINT stats_mat_next_matchday_id_1ebe1a93ab1d5bb1_fk_stats_matchday_id FOREIGN KEY (`next_matchday_id`) REFERENCES `stats_matchday` (`id`);
...
CREATE INDEX stats_matchday_b11701f0 ON `stats_matchday` (`season_id`);
ALTER TABLE `stats_matchday` ADD CONSTRAINT stats_matchday_season_id_4f6a3705d464f68e_fk_stats_season_id FOREIGN KEY (`season_id`) REFERENCES `stats_season` (`id`);
...
CREATE INDEX stats_game_9f35f176 ON `stats_game` (`matchday_id`);
ALTER TABLE `stats_game` ADD CONSTRAINT stats_game_matchday_id_5f0d938ee1a8ad49_fk_stats_matchday_id FOREIGN KEY (`matchday_id`) REFERENCES `stats_matchday` (`id`);
CREATE INDEX stats_game_efa3f36d ON `stats_game` (`next_game_id`);
ALTER TABLE `stats_game` ADD CONSTRAINT stats_game_next_game_id_34a322f8184d117f_fk_stats_game_id FOREIGN KEY (`next_game_id`) REFERENCES `stats_game` (`id`);
...
COMMIT;
BEGIN;
CREATE TABLE `stats_address` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `street` varchar(128) NOT NULL, `city` varchar(64) NOT NULL, `state` varchar(2) NOT NULL, `zip_code` varchar(16) NOT NULL, `phone` varchar(16) NOT NULL, `email` varchar(75) NOT NULL);
CREATE TABLE `stats_card` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `minute` smallint NOT NULL, `color` varchar(1) NOT NULL);
CREATE TABLE `stats_classification` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `label` varchar(32) NOT NULL UNIQUE, `slug` varchar(32) NOT NULL UNIQUE);
CREATE TABLE `stats_club` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL UNIQUE, `address_id` integer NULL);
CREATE TABLE `stats_coach` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY);
CREATE TABLE `stats_coachfor` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `from_date` date NOT NULL, `to_date` date NULL, `responsiblity` varchar(1) NOT NULL, `coach_id` integer NOT NULL);
CREATE TABLE `stats_competition` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL UNIQUE, `mode` varchar(1) NOT NULL, `classification_id` integer NOT NULL);
CREATE TABLE `stats_field` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `address_id` integer NOT NULL);
CREATE TABLE `stats_game` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date` date NOT NULL, `name` varchar(64) NOT NULL);
CREATE TABLE `stats_goal` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `minute` smallint NOT NULL);
CREATE TABLE `stats_matchday` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `next_matchday_id` integer NULL);
CREATE TABLE `stats_person` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `first_name` varchar(64) NOT NULL, `middle_name` varchar(64) NOT NULL, `last_name` varchar(64) NOT NULL, `birthday` date NOT NULL, `gender` varchar(1) NOT NULL, `address_id` integer NULL);
CREATE TABLE `stats_player` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `person_id` integer NOT NULL);
CREATE TABLE `stats_playfor` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `from_date` date NOT NULL, `to_date` date NULL, `player_id` integer NOT NULL);
CREATE TABLE `stats_referee` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `person_id` integer NOT NULL);
CREATE TABLE `stats_season` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `label` varchar(9) NOT NULL, `slug` varchar(9) NOT NULL, `start_date` date NOT NULL, `end_date` date NOT NULL);
CREATE TABLE `stats_suspension` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date_received` date NOT NULL, `number_games` smallint NOT NULL, `suspended_until` date NOT NULL, `reason` varchar(1024) NOT NULL, `fine` smallint NOT NULL, `fine_paid` bool NOT NULL, `player_id` integer NOT NULL);
CREATE TABLE `stats_team` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL UNIQUE, `colors` varchar(128) NOT NULL, `classification_id` integer NOT NULL, `club_id` integer NULL);
CREATE TABLE `stats_season_enrolled` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `season_id` integer NOT NULL, `team_id` integer NOT NULL, UNIQUE (`season_id`, `team_id`));
ALTER TABLE `stats_season` ADD COLUMN `of_id` integer NOT NULL;
ALTER TABLE `stats_season` ALTER COLUMN `of_id` DROP DEFAULT;
ALTER TABLE `stats_playfor` ADD COLUMN `team_id` integer NOT NULL;
...
CREATE INDEX stats_coachfor_ea814e95 ON `stats_coachfor` (`coach_id`);
ALTER TABLE `stats_coachfor` ADD CONSTRAINT stats_coachfor_coach_id_41e4215015b93ccc_fk_stats_coach_id FOREIGN KEY (`coach_id`) REFERENCES `stats_coach` (`id`);
CREATE INDEX stats_competition_946aa2ca ON `stats_competition` (`classification_id`);
ALTER TABLE `stats_competition` ADD CONSTRAINT st_classification_id_7f5c3bc1890c3cc0_fk_stats_classification_id FOREIGN KEY (`classification_id`) REFERENCES `stats_classification` (`id`);
CREATE INDEX stats_field_ea8e5d12 ON `stats_field` (`address_id`);
ALTER TABLE `stats_field` ADD CONSTRAINT stats_field_address_id_37ebfde016c42162_fk_stats_address_id FOREIGN KEY (`address_id`) REFERENCES `stats_address` (`id`);
CREATE INDEX stats_matchday_2dbcba41 ON `stats_matchday` (`slug`);
CREATE INDEX stats_matchday_0783d889 ON `stats_matchday` (`next_matchday_id`);
ALTER TABLE `stats_matchday` ADD CONSTRAINT stats_mat_next_matchday_id_1ebe1a93ab1d5bb1_fk_stats_matchday_id FOREIGN KEY (`next_matchday_id`) REFERENCES `stats_matchday` (`id`);
CREATE INDEX stats_person_ea8e5d12 ON `stats_person` (`address_id`);
ALTER TABLE `stats_person` ADD CONSTRAINT stats_person_address_id_723582a4ef700afe_fk_stats_address_id FOREIGN KEY (`address_id`) REFERENCES `stats_address` (`id`);
...
CREATE INDEX stats_referee_a8452ca7 ON `stats_referee` (`person_id`);
ALTER TABLE `stats_referee` ADD CONSTRAINT stats_referee_person_id_6f8b3b6a22267f0a_fk_stats_person_id FOREIGN KEY (`person_id`) REFERENCES `stats_person` (`id`);
CREATE INDEX stats_season_2dbcba41 ON `stats_season` (`slug`);
CREATE INDEX stats_suspension_afe72417 ON `stats_suspension` (`player_id`);
ALTER TABLE `stats_suspension` ADD CONSTRAINT stats_suspension_player_id_1e43e4fe392d9324_fk_stats_player_id FOREIGN KEY (`player_id`) REFERENCES `stats_player` (`id`);
CREATE INDEX stats_team_946aa2ca ON `stats_team` (`classification_id`);
ALTER TABLE `stats_team` ADD CONSTRAINT st_classification_id_66428990c9aca321_fk_stats_classification_id FOREIGN KEY (`classification_id`) REFERENCES `stats_classification` (`id`);
CREATE INDEX stats_team_7115697a ON `stats_team` (`club_id`);
ALTER TABLE `stats_team` ADD CONSTRAINT stats_team_club_id_5837c0f04cf87d9f_fk_stats_club_id FOREIGN KEY (`club_id`) REFERENCES `stats_club` (`id`);
CREATE INDEX stats_season_enrolled_b11701f0 ON `stats_season_enrolled` (`season_id`);
ALTER TABLE `stats_season_enrolled` ADD CONSTRAINT stats_season_enrol_season_id_3f8228a1ca5434f1_fk_stats_season_id FOREIGN KEY (`season_id`) REFERENCES `stats_season` (`id`);
...
CREATE TABLE `stats_coach` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY);
CREATE TABLE `stats_coachfor` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `from_date` date NOT NULL, `to_date` date NULL, `responsiblity` varchar(1) NOT NULL, `coach_id` integer NOT NULL);
CREATE TABLE `stats_competition` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `mode` varchar(1) NOT NULL, `classification_id` integer NOT NULL);
CREATE TABLE `stats_field` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `address_id` integer NOT NULL);
CREATE TABLE `stats_game` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date` date NOT NULL, `name` varchar(64) NOT NULL);
CREATE TABLE `stats_goal` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `minute` smallint NOT NULL);
CREATE TABLE `stats_matchday` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `next_matchday_id` integer NULL);
CREATE TABLE `stats_person` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `first_name` varchar(64) NOT NULL, `middle_name` varchar(64) NOT NULL, `last_name` varchar(64) NOT NULL, `birthday` date NULL, `gender` varchar(1) NOT NULL, `address_id` integer NULL);
CREATE TABLE `stats_player` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `person_id` integer NOT NULL UNIQUE);
CREATE TABLE `stats_playfor` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `from_date` date NOT NULL, `to_date` date NULL, `player_id` integer NOT NULL);
CREATE TABLE `stats_referee` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `person_id` integer NOT NULL UNIQUE);
CREATE TABLE `stats_season` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `label` varchar(9) NOT NULL, `slug` varchar(9) NOT NULL, `start_date` date NOT NULL, `end_date` date NOT NULL, `competition_id` integer NOT NULL);
CREATE TABLE `stats_suspension` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date_received` date NOT NULL, `number_games` smallint NOT NULL, `suspended_until` date NOT NULL, `reason` varchar(1024) NOT NULL, `fine` smallint NOT NULL, `fine_paid` bool NOT NULL, `player_id` integer NOT NULL);
CREATE TABLE `stats_team` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL UNIQUE, `colors` varchar(128) NOT NULL, `classification_id` integer NOT NULL, `club_id` integer NULL);
CREATE TABLE `stats_season_enrolled` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `season_id` integer NOT NULL, `team_id` integer NOT NULL, UNIQUE (`season_id`, `team_id`));
ALTER TABLE `stats_playfor` ADD COLUMN `team_id` integer NOT NULL;
...
ALTER TABLE `stats_coachfor` ADD COLUMN `team_id` integer NOT NULL;
ALTER TABLE `stats_coachfor` ALTER COLUMN `team_id` DROP DEFAULT;
ALTER TABLE `stats_coach` ADD COLUMN `person_id` integer NOT NULL UNIQUE;
ALTER TABLE `stats_coach` ALTER COLUMN `person_id` DROP DEFAULT;
ALTER TABLE `stats_card` ADD COLUMN `received_by_id` integer NOT NULL;
ALTER TABLE `stats_card` ALTER COLUMN `received_by_id` DROP DEFAULT;
ALTER TABLE `stats_card` ADD COLUMN `received_in_id` integer NOT NULL;
...
CREATE INDEX stats_coachfor_ea814e95 ON `stats_coachfor` (`coach_id`);
ALTER TABLE `stats_coachfor` ADD CONSTRAINT stats_coachfor_coach_id_41e4215015b93ccc_fk_stats_coach_id FOREIGN KEY (`coach_id`) REFERENCES `stats_coach` (`id`);
CREATE INDEX stats_competition_2dbcba41 ON `stats_competition` (`slug`);
CREATE INDEX stats_competition_946aa2ca ON `stats_competition` (`classification_id`);
ALTER TABLE `stats_competition` ADD CONSTRAINT st_classification_id_7f5c3bc1890c3cc0_fk_stats_classification_id FOREIGN KEY (`classification_id`) REFERENCES `stats_classification` (`id`);
CREATE INDEX stats_field_2dbcba41 ON `stats_field` (`slug`);
CREATE INDEX stats_field_ea8e5d12 ON `stats_field` (`address_id`);
ALTER TABLE `stats_field` ADD CONSTRAINT stats_field_address_id_37ebfde016c42162_fk_stats_address_id FOREIGN KEY (`address_id`) REFERENCES `stats_address` (`id`);
CREATE INDEX stats_matchday_2dbcba41 ON `stats_matchday` (`slug`);
CREATE INDEX stats_matchday_0783d889 ON `stats_matchday` (`next_matchday_id`);
...
ALTER TABLE `stats_referee` ADD CONSTRAINT stats_referee_person_id_6f8b3b6a22267f0a_fk_stats_person_id FOREIGN KEY (`person_id`) REFERENCES `stats_person` (`id`);
CREATE INDEX stats_season_2dbcba41 ON `stats_season` (`slug`);
CREATE INDEX stats_season_88606bbe ON `stats_season` (`competition_id`);
ALTER TABLE `stats_season` ADD CONSTRAINT stats_se_competition_id_251413d948a917d1_fk_stats_competition_id FOREIGN KEY (`competition_id`) REFERENCES `stats_competition` (`id`);
CREATE INDEX stats_suspension_afe72417 ON `stats_suspension` (`player_id`);
ALTER TABLE `stats_suspension` ADD CONSTRAINT stats_suspension_player_id_1e43e4fe392d9324_fk_stats_player_id FOREIGN KEY (`player_id`) REFERENCES `stats_player` (`id`);
CREATE INDEX stats_team_946aa2ca ON `stats_team` (`classification_id`);
ALTER TABLE `stats_team` ADD CONSTRAINT st_classification_id_66428990c9aca321_fk_stats_classification_id FOREIGN KEY (`classification_id`) REFERENCES `stats_classification` (`id`);
...
CREATE TABLE `stats_coachfor` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `from_date` date NOT NULL, `to_date` date NULL, `responsiblity` varchar(1) NOT NULL, `coach_id` integer NOT NULL);
CREATE TABLE `stats_competition` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `mode` varchar(1) NOT NULL, `classification_id` integer NOT NULL);
CREATE TABLE `stats_field` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL UNIQUE, `address_id` integer NOT NULL);
CREATE TABLE `stats_game` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `date` date NOT NULL, `name` varchar(64) NOT NULL);
CREATE TABLE `stats_goal` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `minute` smallint NOT NULL);
CREATE TABLE `stats_matchday` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL, `slug` varchar(64) NOT NULL, `next_matchday_id` integer NULL);
CREATE TABLE `stats_person` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `first_name` varchar(64) NOT NULL, `middle_name` varchar(64) NOT NULL, `last_name` varchar(64) NOT NULL, `birthday` date NULL, `gender` varchar(1) NOT NULL, `address_id` integer NULL);
